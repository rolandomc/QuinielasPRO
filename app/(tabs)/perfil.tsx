...
const styles = StyleSheet.create({
  ...
  username:{color:C.text,fontSize:22,fontWeight:'bold'}, nombre:{color:C.textSub,fontSize:14,marginTop:2}, email:{color:'#555577',fontSize:12,marginTop:4},
  ...
  statNum:{fontSize:26,fontWeight:'bold',color:C.text}, statLabel:{fontSize:11,color:C.textSub,marginTop:3},
  seccionTitulo:{color:C.text,fontSize:17,fontWeight:'bold',marginHorizontal:16,marginBottom:10},
  ...
  qEstadoRow:{flexDirection:'row',alignItems:'center',gap:5}, qEstado:{fontSize:13,fontWeight:'600'},
  qAciertosBox:{alignItems:'center',flexDirection:'row',gap:4},
  qAciertosNum:{fontSize:20,fontWeight:'bold',color:C.accent}, qAciertosLabel:{fontSize:11,color:C.textSub},
