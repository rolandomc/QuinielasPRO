...
export const apifb = {
  ligas: (search: string) => call('leagues', { search, current: 'true' }),
  ligasPorPais: (country: string) => call('leagues', { country, current: 'true' }),
  ...
  fixtureById: (id: string) =>
    call('fixtures', { id }),
  temporadaActual: (leagueId: string) =>
    call('leagues', { id: leagueId, current: 'true' }),
};
